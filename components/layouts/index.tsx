...
const Layout = () => {
  // Use an async function to get the session
        ...
        <div style={{ width: '100%' }}>
          {session ? (
            <>
              ...
              <Header />
              {/* Add additional content for signed-in users if needed */}
            </>
          ) : (
            <>
          ...
          <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
            <p className="text-sm leading-6 text-gray-900">
              <strong className="font-semibold">Advertising?</strong>
              <svg
                viewBox="0 0 2 2"
              ...
              Join our waitlist by June 7 – register your site for free.
            </p>
            <a
              href="/login"
            ...
            >
              Open Seller Account <span aria-hidden="true">&rarr;</span>
            </a>
          </div>
